"""add: fts (full text search) for products table

Revision ID: f1cb74cd42f1
Revises: a8e4220af9be
Create Date: 2026-06-14 12:34:28.091350
...
revision: str = 'f1cb74cd42f1'
down_revision: Union[str, Sequence[str], None] = 'a8e4220af9be'
